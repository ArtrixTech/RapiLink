...
front_blueprint = Blueprint('front_old', __name__, template_folder="templates", static_folder="static", subdomain="old")
www_jump_blueprint = Blueprint('jump_old', __name__, template_folder="templates", static_folder="static", subdomain="www")
